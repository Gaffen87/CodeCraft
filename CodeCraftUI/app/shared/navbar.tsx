...
export default function Navbar() {
	...
	return (
		<div className="bg-blue-950 px-4 py-4 flex items-center">
			...
			<span className="mr-7 text-2xl text-shadow-lg/80">CodeCraft</span>
			...
			<button
				className="px-4 py-2 ml-auto inset-ring rounded-lg hover:inset-ring-2 hover:cursor-pointer transition-all"
				onClick={signOut}
			>
				Log out
			</button>
