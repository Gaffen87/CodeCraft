...
import ExerciseStepUpdateEditor from "./exercise-step-update-editor";
import type { CreateSubExercise } from "~/types/types";

export default function SubExerciseUpdateEditor({
	exercise,
	setExercise,
}: {
	exercise: any;
